...
if channel_type == "BEC":
    main_path = "/data/adina/MH_Project/Data/BEC"
    ...
    main_path = f"/data/adina/MH_Project/Data/GE_p_{p}_g_{erasure_prob_good}_b_{erasure_prob_bad}"
    
    # main_path = os.path.join('data', 'adina', 'MH_Project', 'Data', f'GE_p_{p}_g_{erasure_prob_good}_b_{erasure_prob_bad}')
