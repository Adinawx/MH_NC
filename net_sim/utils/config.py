...
CFG = {
    ...
    "param": {
        ...
        "er_rates": [0.2, 0.3, 0.2, 0.1, 0.1],  # erasure rate of each channel: 0=perfect, 1=all erasure
        "er_var_ind": [3],  # Indices to vary - can't be empty. To have all channels at fixed rate - choose one index and set er_var_values to be one value.
        ...
        "er_type": "GE_p_0.1_q_0.3_g_0.01_b_0.8",  # erasure type: BEC, GE_p_0.1_q_0.3_g_0.01_b_0.8, For the GE only one channel is going to be GE.
