...
CFG = {
    ...
    "param": {
        ...
        "results_filename": "22222222222222222222",  # results filename - must change each run
        "timesteps": 100,  # number of timesteps in each rep
        "debug": False,  # debug flag
        "rep": 1,  # number of repetitions
        "er_rates": [0.3, 0.3, 0.3],  # erasure rate of each channel: 0=perfect, 1=all erasure
        ...
        "er_var_values": [0.3, 0.3, 1],  # Values to vary - same to all indices - star, end, steps number
